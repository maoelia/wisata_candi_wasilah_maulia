...
class _SearchScreenState extends State<SearchScreen> {
  //TODO: 1. Deklarsikan variabel yang dibutuhkan
  List<Candi> _filteredCandis = candiList; //daftar candi
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          //TODO: 4. Buat Textfield pencarian sebagai anak dari colum
          Padding(
            ...
            child: Container(
              ...
              child: TextField(
                controller: _searchController, //cari candi
                ...
                decoration: InputDecoration(
                  ...
                  //menampilkan hasil pencarian candi
                  onChanged: (value) {
                    setState(() {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // TODO: 8. Implementasi GestureDetetctor dan Hero animation
                return Card(
